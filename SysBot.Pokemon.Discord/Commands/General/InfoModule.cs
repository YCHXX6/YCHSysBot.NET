...
{
    private const string detail = "我是一个开源的 Discord 机器人，由 PKHeX.Core 等开源软件驱动。";
    ...
    public async Task InfoAsync()
    {
        ...
        await ReplyAsync("这是我的一些信息！", embed: builder.Build()).ConfigureAwait(false);
    }
